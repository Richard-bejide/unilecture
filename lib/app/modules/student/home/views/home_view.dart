      ...
      children: [
        Row(
          ...
          children: [
            Obx(
              () => Text(
                '${controller.selectedClassesFilter.value == 1 ? 'Today' : 'Tomorrow'}\'s Classes',
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.toNamed(Routes.JOINEDCLASSES);
              },
              child: Container(
                padding: const EdgeInsets.all(8.0),
                  ...
                  : SizedBox(
                      ...
                      child: Obx(
                        () => ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              CourseModel? course = homeController.allClasses[index];
                              return Padding(
