...
class TeacherCourseStudentsView extends GetView<TeacherCourseStudentsController> {
  const TeacherCourseStudentsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        floatingActionButton: controller.currentView.value == 1
            ? const SizedBox()
              ...
              GestureDetector(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      ...
                      decoration: controller.currentView.value == 1 ? TextDecoration.underline : TextDecoration.none),
                ),
              ),
              GestureDetector(
                onTap: () {
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      ...
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      decoration: controller.currentView.value == 2 ? TextDecoration.underline : TextDecoration.none),
                ),
              ),
            ],
          ),
