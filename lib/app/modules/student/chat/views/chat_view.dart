...
import 'package:uni_lecture/app/modules/student/course_students/controllers/course_students_controller.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Get.toNamed(Routes.COURSESTUDENTS);
                            final courseStudentsController = Get.put(CourseStudentsController());
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Padding(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: messages['senderID'].trim() == homeController.uid.trim() ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                          children: [
                            Row(
                              mainAxisAlignment:
                              messages['senderID'].trim() == homeController.uid.trim() ? MainAxisAlignment.end : MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                            ...
                            ChatBubble(
                              ...
                              sender: messages['senderID'].trim() == homeController.uid.trim() ? MessageSender.me : MessageSender.boss,
